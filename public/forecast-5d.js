(function () {
    ...
    function render(data) {
        ...
        var maxTemp = $('#forecast svg #maxTemp')[0];
        var tempPath = $('#forecast svg path')[0];
        var icons = $('#forecast #icons')[0];
        var times = $('#forecast #times')[0];
        var fd = $('#forecast #firstDate')[0];
        var ld = $('#forecast #lastDate')[0];
        // Reset
        ...
        for (var i in data) {
            ...
            icon.src = `https://openweathermap.org/img/w/${chunk.weather[0].icon}.png`;
            ...
            t.innerText = formatTime(chunk.date);
            times.appendChild(t);
        }
        var points = [];
